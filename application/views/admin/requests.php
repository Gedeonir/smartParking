                                                ...
                                                <div class="table-responsive m-b-40">
                                                    <table class="table table-borderless table-data3">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                            $num= 1;
                                                            foreach($reqData as $hist) { 
                                                            ?>
                                                            <tr>

                                                                <td><?php echo $num; ?></td>
                                                                <td><?php echo $hist->space_code; ?></td>
                                                                <td data-toggle="tooltip" data-placement="bottom" title="<?php echo $hist->firstname." ".$hist->lastname; ?>"><?php echo $hist->veh_plateno; ?></td>
                                                                ...
                                                                <td class="text-right"><a class="btn btn-primary" href="<?php echo base_url("parking/check/$hist->bk_id"); ?>">Check</a></td>
                                                            </tr>
                                                            <?php $num++; } ?>
